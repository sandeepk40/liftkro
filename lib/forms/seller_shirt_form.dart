...
class SellerShirtForm extends StatefulWidget {
  const SellerShirtForm({Key? key}) : super(key: key);
  static const String id = 'shirt-form';

  @override
  State<SellerShirtForm> createState() => _SellerShirtFormState();
}

class _SellerShirtFormState extends State<SellerShirtForm> {
                ...
                children: [
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      labelText: 'Type*',
                      helperText: 'Shirt/Reglular-Fit/Loose-Fit...',
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      //labelText: 'Tap here to add jeans type'),
                      labelText: 'Brand*',
                      helperText: 'Arrow,Peter England/...',
                      labelStyle: const TextStyle(color: Colors.black),
                      helperStyle: const TextStyle(color: Colors.black),
                      errorStyle: const TextStyle(color: Colors.red),
                      contentPadding: const EdgeInsets.symmetric(
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      labelText: 'Material*',
                      helperText: 'Cotton/ Poly-Cotton Blend/Linen...',
                      labelStyle: const TextStyle(color: Colors.black),
                      helperStyle: const TextStyle(color: Colors.black),
                      errorStyle: const TextStyle(color: Colors.red),
                      contentPadding: const EdgeInsets.symmetric(
