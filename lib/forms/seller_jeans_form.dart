...
class SellerJeansForm extends StatefulWidget {
  const SellerJeansForm({Key? key}) : super(key: key);
  static const String id = 'jeans-form';

  @override
  State<SellerJeansForm> createState() => _SellerJeansFormState();
}

class _SellerJeansFormState extends State<SellerJeansForm> {
